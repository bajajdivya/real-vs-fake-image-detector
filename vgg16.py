...
# Save the entire code and outputs to a PDF named 'vgg16.pdf'
from matplotlib.backends.backend_pdf import PdfPages

with PdfPages('vgg16.pdf') as pdf:
    plt.figure(figsize=(10, 8))
    plt.subplot(2, 1, 1)
