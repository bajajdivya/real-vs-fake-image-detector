...
# Save the entire code and outputs to a PDF named 'inception.pdf'
from matplotlib.backends.backend_pdf import PdfPages

with PdfPages('inception.pdf') as pdf:
    plt.figure(figsize=(10, 8))
    plt.subplot(2, 1, 1)
